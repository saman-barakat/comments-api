...
module OpenapiClient
  class User
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'nice_name')
        self.nice_name = attributes[:'nice_name']
      end
      ...
      if attributes.key?(:'blogs')
        if (value = attributes[:'blogs']).is_a?(Array)
          self.blogs = value
        end
      end
    ...
    def hash
      [id, username, password, nice_name, avatar_url, display_name, email, role, blogs, verification_status].hash
    end
