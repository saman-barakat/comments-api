...
public class JsonUtil {
  ...
  public static Type getListTypeForDeserialization(Class cls) {
    ...
    if ("Blog".equalsIgnoreCase(className)) {
      return new TypeToken<List<Blog>>(){}.getType();
    }
    ...
    if ("VerificationStatus".equalsIgnoreCase(className)) {
      return new TypeToken<List<VerificationStatus>>(){}.getType();
    }
  ...
  public static Type getTypeForDeserialization(Class cls) {
    ...
    if ("Blog".equalsIgnoreCase(className)) {
      return new TypeToken<Blog>(){}.getType();
    }
    ...
    if ("VerificationStatus".equalsIgnoreCase(className)) {
      return new TypeToken<VerificationStatus>(){}.getType();
    }
