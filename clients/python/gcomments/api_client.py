...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BlogApi()
        api_instance.add_blog  # this is an instance of the class Endpoint
        api_instance.add_blog()  # this invokes api_instance.add_blog.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_blog.callable or self.callable in this class
